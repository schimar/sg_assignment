...
The vcf files for all four callsets can be found in the subfolder "vars", with fbvars19rlxd_fltrd.tar.gz and bbvars19rlxd_fltrd.tar.gz being the *freebayes* and *bbtools* vcf files with the relaxed parameters and the remaining two vcf files are called with stricter parameters. 
